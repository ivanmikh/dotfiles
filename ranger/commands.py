...
class sbl(Command):
    ...
    def execute(self):
        ...
        command = "svn blame " + filename + " | vim -"
        flags = ''
...
class fzf_select(Command):
    ...
    def execute(self):
        ...
        if self.quantifier:
            ...
            -o -type d -print 2> /dev/null | sed 1d | cut -b3- | fzf +m " + args
        else:
            # match files and directories
            command="find -L . \( -path '*/\.*' -o -fstype 'dev' -o -fstype 'proc' \) -prune \
            -o -print 2> /dev/null | sed 1d | cut -b3- | fzf +m " + args
